...
// ==========================================
// BAGIAN 1: Struktur dan Pemetaan Error
// ==========================================
...
// ==========================================
// BAGIAN 2: Daftar, Ambil Satu, Tambah
// ==========================================
...
func (h *UserHandler) Create(c *fiber.Ctx) error {
	...
	return created(c, "user berhasil dibuat", baru, "/api/v1/users/"+strconv.Itoa(baru.ID))
}

// ==========================================
// BAGIAN 3: PUT, PATCH, DELETE
// ==========================================
...
// paramID mengambil parameter "id" dari URL dan mengubahnya menjadi integer
